...
尽量考虑算力相对充裕的厂商，额度再差也比天天 429 报错强
...
- 💰 **一般场景按用量计费推荐：`DeepSeek V4 Flash`**
  - **特点**：速度稳定在 50 TPS 以上，1M 上下文，缓存读 1/100 的价格领先业界 1/10 一代，百万 Token 输入 1 元，输出 2 元，性价比最高模型，1 亿 Token 约 9 元（输入输出比 115:1）
  - **劣势**：不支持多模态，无订阅方案重度使用下还是比 Coding Plan 贵不少
...
| :--- |  :--- | :--- | :--- | ---: |
| kimi-k2.5🏞️ | 2026-01-27 | 1.1T A32B| 256K| 87.99% |
| kimi-k2.6🏞️ |  2026-04-20 | 1.1T A32B| 256K| 87.99% |
...
| mimo-v2-flash🏞️ | 2025-12-16 | 309B A15B | 256K | 101.18% |
