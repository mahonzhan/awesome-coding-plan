...
- 🎁 **个人想白嫖: `Nvidia NIM`**
  - **特点**：glm-5/glm-4.7/minimax-m2.7/kimi-k2.5 等开源模型，速率限制 Up to 40 rpm 不限量免费使用 [点此直达](https://build.nvidia.com/) 
  - **劣势**：部分模型为量化版本，注意甄别，无稳定性保证，速度因模型而异，免费不可持续
...
| Nvidia NIM (glm-4.7) |  免费   |   glm-5/glm-4.7/minimax-m2.7/kimi-k2.5 等开源模型 Up to 40 rpm 不限量使用  |   38.7   |         |           |     |        |           |      |     |             |     |
