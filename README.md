...
- 🎁 **个人想白嫖: `Nvidia NIM`**
  - **特点**：kimi-k2.5/minimax-m2.7/glm-5 等开源模型，速率限制 Up to 40 rpm 不限量免费使用 [点此直达](https://build.nvidia.com/) 
  - **劣势**：无稳定性保证，速度因模型而异，免费不可持续
...
| Nvidia NIM (kimi-k2.5) |  免费   |   kimi-k2.5/minimax-m2.7/glm-5 等开源模型 Up to 40 rpm 不限量使用  |   38.7   |         |           |     |        |           |      |     |             |     |
